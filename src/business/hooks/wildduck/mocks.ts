...
export class WildDuckMockData {
  ...
  static getMailboxes() {
    return {
      ...
      data: {
        mailboxes: [
          { id: 'inbox', name: 'INBOX', path: 'INBOX', specialUse: '\\Inbox', messages: 42 },
          { id: 'sent', name: 'Sent', path: 'Sent', specialUse: '\\Sent', messages: 15 },
          { id: 'drafts', name: 'Drafts', path: 'Drafts', specialUse: '\\Drafts', messages: 3 },
          { id: 'trash', name: 'Trash', path: 'Trash', specialUse: '\\Trash', messages: 8 }
        ]
      }
    };
  }
  ...
  static getUsers() {
    return {
      ...
      data: {
        users: [
          { id: 'user1', username: 'user1@example.com', name: 'Mock User 1', activated: true },
          { id: 'user2', username: 'user2@example.com', name: 'Mock User 2', activated: true },
          { id: 'user3', username: 'user3@example.com', name: 'Mock User 3', activated: false }
        ],
        total: 3,
        page: 1,
        pages: 1
  ...
  static getUserAddresses() {
    return {
      ...
      data: {
        addresses: [
          { id: 'addr1', address: 'main@example.com', main: true, created: new Date().toISOString() },
          { id: 'addr2', address: 'alias@example.com', main: false, created: new Date().toISOString() }
        ]
      }
    };
  }
  ...
  static getForwardedAddresses() {
    return {
      ...
      data: {
        addresses: [
          { id: 'fwd1', address: 'forward@example.com', target: 'destination@example.com' }
        ]
      }
    };
  }
  ...
  static getResolveAddress(address: string): { success: boolean; user?: string } {
