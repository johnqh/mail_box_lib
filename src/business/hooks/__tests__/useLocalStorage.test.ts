...
describe('useLocalStorage', () => {
  ...
  describe('initialization', () => {
    ...
    it('should work with complex objects', () => {
      const complexObject = { user: { name: 'John', age: 30 }, preferences: ['dark-mode'] };
  ...
  describe('custom serialization', () => {
    it('should use custom serialize and deserialize functions', () => {
      ...
      const customDeserialize = vi.fn((value: string) => parseInt(value.replace('custom:', ''), 10));
  ...
  describe('event listeners', () => {
    it('should set up storage event listeners', () => {
      ...
      expect(addEventListener).toHaveBeenCalledWith('local-storage', expect.any(Function));
    });
    ...
    it('should clean up event listeners on unmount', () => {
      ...
      expect(removeEventListener).toHaveBeenCalledWith('local-storage', expect.any(Function));
    });
    ...
    it('should handle storage events from other tabs', () => {
      ...
      const storageHandler = addEventListener.mock.calls.find(call => call[0] === 'storage')?.[1];
    ...
    it('should handle custom events for same-tab synchronization', () => {
      ...
      const customHandler = addEventListener.mock.calls.find(call => call[0] === 'local-storage')?.[1];
