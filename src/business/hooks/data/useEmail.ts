...
const convertFullWildDuckMessage = (
  response: WildDuckMessageResponse
): Email => {
  ...
  return {
    ...
    body:
      wildDuckMessage.html || wildDuckMessage.text || 'No content available',
    ...
    async (id: string | null) => {
      ...
      try {
        ...
        try {
          ...
          const fallbackEmail = await emailService.getEmail(
            userId || 'user',
            id
          );
          ...
          try {
            ...
            const mockEmail = await mockEmailService.getEmail(
              userId || 'user',
              id
            );
            setEmail(mockEmail);
