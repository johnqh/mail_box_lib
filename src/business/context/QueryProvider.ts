 ...
 * Usage:
 * ```tsx
 * import { QueryClientProvider, getQueryClient } from '@sudobility/mail_box_lib';
 *
 * function App() {
 *   return (
 ...
 */
const getQueryClient = getGlobalQueryClient;

export { QueryClientProvider, useQueryClient, getQueryClient };
